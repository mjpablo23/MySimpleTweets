...
* [tried but didn't work] User can **click a link within a tweet body** on tweet details view. The click will launch the web browser with relevant page opened.
...
* [tried but didn't work] [Leverage RecyclerView](http://guides.codepath.com/android/Using-the-RecyclerView) as a replacement for the ListView and ArrayAdapter for all lists of tweets.
...
* [y] Tweets that are too long are not posted, shows Toast message

## Video Walkthrough

Here's a walkthrough of implemented user stories:

![alt tag](http://i.imgur.com/re8ZPkK.gifv)
<img src='http://i.imgur.com/re8ZPkK.gifv' title='Video Walkthrough' width='' alt='Video Walkthrough' />
